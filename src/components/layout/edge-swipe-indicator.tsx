...
export function EdgeSwipeIndicator({ activeEdge, swipeOffset }: EdgeSwipeIndicatorProps) {
  ...
  return (
    ...
    >
      <div
        className={cn(
          'flex h-10 w-10 items-center justify-center rounded-full bg-background/90 shadow-lg border border-border/60 backdrop-blur-sm transition-transform duration-100',
