...
import { useNativeStatusBar, useDeepLinks, usePushNotifications, useShareExtensionSync, useWidgetSync, useAppFocusRefresh } from '@/hooks/native';
...
export function AppShell({ children }: AppShellProps) {
  ...
  return (
    <div data-app-viewport className="fixed inset-0 flex overflow-hidden bg-background">
